...
const taskSources = require('./tasks/sources');
const taskManifest = require('./tasks/manifest');
...
gulp.task('build', done => {
    ...
    process.env.buildTimestamp = moment().format('x');

    const tasks = [taskClean, taskSprite, taskImages, taskTemplates, taskStyles, taskScripts, taskStatic, taskManifest];
